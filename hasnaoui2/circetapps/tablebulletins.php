                                                ...
                                                <table id="tabledemande" class="table table-striped table table-responsive table-hover ">
                                                    ...
                                                    while ($bulletin = $resultat1->fetch()) { ?>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td><?php echo $SESSION['user']['pseudo'] ?></td>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="bulletins/'<?php echo $bulletin['chemin'] ?>" target="_blank" class="fas fa-eye text-white" value="">telecharger</a></td>
                                                        <tr>
                                                        <?php     } ?>
