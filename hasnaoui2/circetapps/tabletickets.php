...
<style type="text/css">
	...
	table.table td a.accepter {
        color: green;
    }
    table.table td a.notifier {
        color: blue;
    }
    table.table td a.rejeter {
        color: red;
    }
    table.table td i {
        font-size: 19px;
...
<body>
        ...
        <div class="table-wrapper shadow table-bordered border-warning  rounded"">
          <table id="tabletickets" class="table table-striped table table-responsive table-hover">     
            <div class="table-title">
                <div class="row ">
                    <div class="col-sm-12 ">
						<h2>Tickets demandes <b>Employés</b></h2>
					</div>
					<div class="col-sm-12 ">
					</div>
                </div>
            ...
            <div class="search-box inline-block float-left mb-2">
            <i class="material-icons ">&#xE8B6;
                ...
                <?php $_SESSION['demande']=$demande;  ?>  
                    ...
                    <td><?php echo $demande['Emp_id']?></td>
                    <td><?php echo $demande['typeDocument'] ?></td> 
                    <td><?php echo $demande['libelle'] ?></td>
                    <td><?php echo date('d-m-Y', strtotime($demande['creeLe']))?></td>
                    <td><?php echo utf8_decode($demande['etatDemande']) ?></td>
                    <td class="inline-block">
                    <a href="#accepterEmployeeModal" class="accepter" data-toggle="modal"><i class="fas fa-check" data-toggle="tooltip" title="Accepter"></i></a>
                    <a href="#rejeterEmployeeModal" class="rejeter" data-toggle="modal"><i class="fas fa-trash-alt" data-toggle="tooltip" title="Rejeter"></i></a>
                    <a href="#notifierEmployeeModal" class="notifier" data-toggle="modal"><i class="fas fa-envelope" data-toggle="tooltip" title="Clôturer et notifier"></i></a>
                    </td>
                <tr>
                    <?php  }?>
                </tbody>
	...
	<!-- accepter Modal HTML -->
	<div id="accepterEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					<div class="modal-header">						
						<h4 class="modal-title">accepter Employee</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">					
						<div class="form-group">
	...
	<!-- rejeter Modal HTML -->
	<div id="rejeterEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					<div class="modal-header">						
						<h4 class="modal-title">rejeter Employee</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">					
